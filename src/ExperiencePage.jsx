        ...
        <FadeIn delay={0.1}>
          <div style={{ marginTop:"3rem" }}>
            ...
            <blockquote style={{ fontFamily:"'Libre Baskerville', serif", fontStyle:"italic",
              ...
              "From the start, this wife-and-husband photography team made us feel comfortable and understood. They didn't just take photos, they told our love story. The way they worked together was seamless and intuitive, capturing multiple angles and emotions we didn't even realize were happening in real time. Every glance, every laugh, every quiet, in-between moment was documented with so much care and artistry.<br /><br />Their talent, professionalism, and heart are unmatched. If you're looking for photographers in the Austin metro area who go beyond posed shots and capture the true essence of your relationship, this is the team. We are beyond grateful and will treasure these photos forever. I will be coming back for more shoots!"
            </blockquote>
            <p style={{ fontFamily:"'Manrope', sans-serif", fontSize:"0.62rem",
